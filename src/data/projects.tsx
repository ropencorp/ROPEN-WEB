...
const projects: Project[] = [
  ...
  { // 03. Marketing Cloud - Portfolio project
    ...
    src: "/assets/projects-screenshots/myportfolio/marketing.png",
    screenshots: ["assets/projects-screenshots/myportfolio/marketing.png"],
    ...
    get content() {
      return (
        <div>
          ...
          <SlideShow
            images={[
              `${BASE_PATH}/myportfolio/marketing.png`,
              `${BASE_PATH}/portfolio/skills.png`,
            ]}
          />
          <TypographyH3 className="my-4 ">Space Theme</TypographyH3>
